...
DOCUMENTATION = r"""
module: infomaniak_dns_record_info

short_description: Retrieve records in Infomaniak DNS service

version_added: 4.1.0

description:
  - Retrieves DNS records in Infomaniak DNS service.
extends_documentation_fragment:
  ...
  - community.dns._module_record_info
