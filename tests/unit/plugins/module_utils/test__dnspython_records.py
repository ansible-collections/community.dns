...
TEST_CONVERT_RDATA_TO_DICT = [
    ...
    (
        dns.rdata.from_text(
            dns.rdataclass.IN, dns.rdatatype.CAA, "10 issue letsencrypt.org"
        ),
        {"to_unicode": True, "add_synthetic": False},
        {
            "flags": 10,
    ...
    (
        dns.rdata.from_text(
            dns.rdataclass.IN, dns.rdatatype.HINFO, '"Generic PC clone" "NetBSD-1.4"'
        ),
        {"to_unicode": False, "add_synthetic": False},
        {
    ...
    (
        dns.rdata.from_text(
            dns.rdataclass.IN,
            dns.rdatatype.LOC,
            "60 9 0.000 N 24 39 0.000 E 10.00m 20.00m 2000.00m 20.00m",
        ),
        {"to_unicode": False, "add_synthetic": False},
        {
            "latitude": [60, 9, 0, 0, 1],
    ...
    (
        dns.rdata.from_text(
            dns.rdataclass.IN,
            dns.rdatatype.NAPTR,
            '65535 65535 "text 1" "text 2" "text 3" example.com.',
        ),
        {"to_unicode": False, "add_synthetic": False},
        {
            "order": 65535,
    ...
    (
        dns.rdata.from_text(
            dns.rdataclass.IN, dns.rdatatype.NSEC, "a.secure A MX RRSIG NSEC TYPE1234"
        ),
        {"to_unicode": False, "add_synthetic": False},
        {
            "next": "a.secure",
    ...
    (
        dns.rdata.from_text(
            dns.rdataclass.IN,
            dns.rdatatype.NSEC3,
            "1 1 123 f00baa23 2t7b4g4vsa5smi47k61mv5bv1a22bojr NS SOA MX RRSIG DNSKEY NSEC3PARAM",
        ),
        {"to_unicode": False, "add_synthetic": False},
        {
            "algorithm": 1,
    ...
    (
        dns.rdata.from_text(
            dns.rdataclass.IN, dns.rdatatype.NSEC3PARAM, "1 1 123 f00baa23"
        ),
        {"to_unicode": False, "add_synthetic": False},
        {
            "algorithm": 1,
    ...
    (
        dns.rdata.from_text(
            dns.rdataclass.IN, dns.rdatatype.RP, "mbox-dname txt-dname"
        ),
        {"to_unicode": False, "add_synthetic": False},
        {
            "mbox": "mbox-dname",
    ...
    (
        dns.rdata.from_text(
            dns.rdataclass.IN,
            dns.rdatatype.SOA,
            "ns.example.com. ns.example.org. 1 7200 900 1209600 86400",
        ),
        {"to_unicode": False, "add_synthetic": False},
        {
    ...
    (
        dns.rdata.from_text(
            dns.rdataclass.IN, dns.rdatatype.SPF, '"v=spf1 a mx" " -all"'
        ),
        {"to_unicode": False, "add_synthetic": False},
        {
    ...
    (
        dns.rdata.from_text(
            dns.rdataclass.IN, dns.rdatatype.SRV, r"0 1 443 exchange.example.com"
        ),
        {"to_unicode": False, "add_synthetic": False},
        {
            "priority": 0,
    ...
    (
        dns.rdata.from_text(
            dns.rdataclass.IN,
            dns.rdatatype.SSHFP,
            r"1 1 aa549bfe898489c02d1715d97d79c57ba2fa76ab",
        ),
        {"to_unicode": False, "add_synthetic": False},
        {
            "algorithm": 1,
    ...
    (
        dns.rdata.from_text(
            dns.rdataclass.IN,
            dns.rdatatype.TLSA,
            r"3 1 1 a9cdf989b504fe5dca90c0d2167b6550570734f7c763e09fdf88904e06157065",
        ),
        {"to_unicode": False, "add_synthetic": False},
        {
            "usage": 3,
