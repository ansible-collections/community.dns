                    ...
                    validate_wsdl_call(
                        [
                            ...
                            expect_wsdl_value(
                                [
                                    lxml.etree.QName(
                                        "https://ns1.hosttech.eu/public/api", "getZone"
                                    ).text,
                                    "sZoneName",
                                ],
                                "example.org",
...
class TestHosttechDNSRecordJSON(BaseTestModule):
    ...
    def test_unknown_zone_id_prefix(self, mocker):
        result = self.run_module_failed(
            ...
            [
                ...
                .expect_header("authorization", "Bearer foo")
                .expect_url(
                    "https://api.ns1.hosttech.eu/api/user/v1/zones/23/records",
                    without_query=True,
                )
    ...
    def test_other_error(self, mocker):
        ...
        assert result["msg"].startswith(
            "Error: GET https://api.ns1.hosttech.eu/api/user/v1/zones?"
        )
        assert (
    ...
    def test_absent_bulk(self, mocker):
        result = self.run_module_success(
            ...
            [
                ...
                .expect_header("authorization", "Bearer foo")
                .expect_url(
                    "https://api.ns1.hosttech.eu/api/user/v1/zones/42/records/130"
                )
                .result_str(""),
                FetchUrlCall("DELETE", 204)
                .expect_header("accept", "application/json")
                .expect_header("authorization", "Bearer foo")
                .expect_url(
                    "https://api.ns1.hosttech.eu/api/user/v1/zones/42/records/131"
                )
                .result_str(""),
                ...
                .expect_header("authorization", "Bearer foo")
                .expect_url(
                    "https://api.ns1.hosttech.eu/api/user/v1/zones/42/records/132"
                )
                .return_header("Content-Type", "application/json")
