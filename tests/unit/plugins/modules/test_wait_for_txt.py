...
class TestWaitForTXT(ModuleTestCase):
                ...
                ("1:2::3", "3.3.3.3"): [
                    {
                        ...
                        "result": create_mock_answer(
                            dns.rrset.from_rdata(
                                ...
                                300,
                                dns.rdata.from_text(
                                    dns.rdataclass.IN, dns.rdatatype.TXT, "asdf"
                                ),
                            )
                        ),
                    },
    ...
    def test_double(self):
                ...
                ("3.3.3.3",): [
                    {
                        ...
                        "result": create_mock_answer(
                            dns.rrset.from_rdata(
                                ...
                                300,
                                dns.rdata.from_text(
                                    dns.rdataclass.IN, dns.rdatatype.TXT, "fdsa"
                                ),
                            )
                        ),
                    },
                    {
                        "target": dns.name.from_unicode("mail.example.com"),
                        "rdtype": dns.rdatatype.TXT,
                        "lifetime": 10,
                        "result": create_mock_answer(
                            dns.rrset.from_rdata(
                                ...
                                300,
                                dns.rdata.from_text(
                                    dns.rdataclass.IN, dns.rdatatype.TXT, '"any bar"'
                                ),
                            )
                        ),
                    },
        ...
        udp_sequence = [
            ...
            {
                "query_target": dns.name.from_unicode("mail.example.com"),
                "query_type": dns.rdatatype.NS,
                "nameserver": "1.1.1.1",
                "kwargs": {
                    "timeout": 10,
                ...
                ("3.3.3.3",): [
                    {
                        ...
                        "result": create_mock_answer(
                            dns.rrset.from_rdata(
                                ...
                                300,
                                dns.rdata.from_text(
                                    dns.rdataclass.IN, dns.rdatatype.TXT, "as df"
                                ),
                                dns.rdata.from_text(
                                    dns.rdataclass.IN,
                                    dns.rdatatype.TXT,
                ...
                ("3.3.3.3",): [
                    {
                        ...
                        "result": create_mock_answer(
                            dns.rrset.from_rdata(
                                ...
                                300,
                                dns.rdata.from_text(
                                    dns.rdataclass.IN, dns.rdatatype.TXT, '"bumble bee"'
                                ),
                            )
                        ),
                    },
                    ...
                    },
                    {
                        ...
                        "result": create_mock_answer(
                            dns.rrset.from_rdata(
                                ...
                                dns.rdata.from_text(
                                    dns.rdataclass.IN, dns.rdatatype.TXT, "bee"
                                ),
                            )
                        ),
                    },
                    ...
                    },
                    {
                        ...
                        "result": create_mock_answer(
                            dns.rrset.from_rdata(
                                ...
                                300,
                                dns.rdata.from_text(
                                    dns.rdataclass.IN, dns.rdatatype.TXT, "bumble"
                                ),
                                dns.rdata.from_text(
                                    dns.rdataclass.IN, dns.rdatatype.TXT, "bee"
                                ),
                                dns.rdata.from_text(
                                    dns.rdataclass.IN, dns.rdatatype.TXT, "wizard"
                                ),
                            )
                        ),
                    },
                    ...
                    },
                    {
                        ...
                        "result": create_mock_answer(
                            dns.rrset.from_rdata(
                                ...
                                dns.rdata.from_text(
                                    dns.rdataclass.IN, dns.rdatatype.TXT, "foo"
                                ),
                            )
                        ),
                    },
                    ...
                    },
                    {
                        ...
                        "result": create_mock_answer(
                            dns.rrset.from_rdata(
                                ...
                                300,
                                dns.rdata.from_text(
                                    dns.rdataclass.IN, dns.rdatatype.TXT, "asdfasdf"
                                ),
                            )
                        ),
                    },
        ...
        with patch("dns.resolver.get_default_resolver", resolver):
            with patch("dns.resolver.Resolver", resolver):
                with patch("dns.query.udp", mock_query_udp(udp_sequence)):
                    with patch("time.sleep", mock_sleep):
                        with patch(
                            "ansible_collections.community.dns.plugins.modules.wait_for_txt.monotonic",
    ...
    def test_servfail(self):
        ...
        assert (
            ...
            == 'Unexpected resolving error: Error SERVFAIL while querying 1.1.1.1 with query get NS for "com."'
        )
        assert exc.value.args[0]["completed"] == 0
        assert len(exc.value.args[0]["records"]) == 1
        assert exc.value.args[0]["records"][0]["name"] == "www.example.com"
    ...
    def test_cname_loop(self):
        ...
        assert (
            exc.value.args[0]["msg"]
            == "Unexpected resolving error: Found CNAME loop starting at www.example.com"
        )
        assert exc.value.args[0]["completed"] == 0
        assert len(exc.value.args[0]["records"]) == 1
        assert exc.value.args[0]["records"][0]["name"] == "www.example.com"
