...
from ansible_collections.community.dns.plugins.modules import (
    infomaniak_dns_record_set_info,
)
...
class TestInfomaniakDNSRecordSetInfoJSON(BaseTestModule):
    MOCK_ANSIBLE_MODULEUTILS_BASIC_ANSIBLEMODULE = "ansible_collections.community.dns.plugins.modules.infomaniak_dns_record_set_info.AnsibleModule"
