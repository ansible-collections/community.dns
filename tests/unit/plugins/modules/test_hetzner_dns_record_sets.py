    ...
    def test_change_add_two_failed(self, mocker):
        result = self.run_module_failed(
            ...
            [
                ...
                .expect_json_value(
                    ["records", 1, "value"], '128 issuewild "letsencrypt.org"'
                )
        ...
        with patch("time.sleep", mock_sleep):
            result = self.run_module_success(
                ...
                [
                    ...
                    .expect_header("Authorization", "Bearer foo")
                    .expect_url(
                        "https://api.hetzner.cloud/v1/zones/42/rrsets/@/SOA/actions/change_ttl"
                    )
                    .expect_json_value(["ttl"], 3600)
                    .expect_json_value_absent(["records"])
                    .return_header("Content-Type", "application/json")
            ...
            with patch("time.sleep", sleep):
                result = self.run_module_success(
                    ...
                    [
                        ...
                        .expect_header("Authorization", "Bearer foo")
                        .expect_url(
                            "https://api.hetzner.cloud/v1/zones/42/rrsets/@/AAAA"
                        )
                        .return_header("Content-Type", "application/json")
                        .result_json(
                            {
                        ...
                        .expect_header("Authorization", "Bearer foo")
                        .expect_url(
                            "https://api.hetzner.cloud/v1/zones/42/rrsets/foo/TXT"
                        )
                        .return_header("Content-Type", "application/json")
                        .result_json(
                            {
